...
pushing. This opt-in lane converts <!-- counts:corpus-documents -->21<!-- counts:end --> complete cached documents and checks reviewed content,
...
`corpus/manifest.json` registers <!-- counts:registered-documents -->21 real documents<!-- counts:end --> by exact byte identity, from the 522-page
