...
<!-- counts:coverage -->
[corpus/regressions.json](../corpus/regressions.json) has 3653 targeted checks on 585 reviewed pages
...
They comprise 1137 ordered-text, 242 text, 472 paragraph, 353 absent-text, 278 heading,
36 heading-level, 64 absent-heading, 88 list-item, 40 list, 21 preformatted-block,
1 preformatted-lines, 34 script, 10 absent-script, 11 footnote, 34 note-link,
...
<!-- counts:swift-tests -->1011 Swift tests<!-- counts:end --> with no known-issue wrappers, and <!-- counts:python-tests -->248 Python tests<!-- counts:end -->.
