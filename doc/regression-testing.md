...
- `swift test`: <!-- counts:swift-tests -->329 Swift Testing tests<!-- counts:end --> with no known-issue wrappers, using the real Apple
...
<!-- counts:contract-coverage -->451 checks on 104 reviewed pages across 18 documents<!-- counts:end -->.
...
Those 451 checks are 4 `spineContinuity`, 76 `text`, 158 `orderedText`, 27 `absentText`,
