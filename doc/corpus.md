...
| --- | --- | --- | --- |
| [`usgs-mcs2025-copper`](../measurements/usgs-mcs2025-copper/record.md) | Borderless tables | Tables preserved as readable crops, but adjacent prose is absorbed into them | [#36](https://github.com/vocaro/PDFReflowLib/issues/36) closed, fix only in `3507d7d01`; live tracker [#229](https://github.com/vocaro/PDFReflowLib/issues/229) |
