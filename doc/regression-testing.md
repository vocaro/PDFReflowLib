...
<!-- counts:coverage -->
[corpus/regressions.json](../corpus/regressions.json) has 3859 targeted checks on 617 reviewed pages
...
1244 ordered-text, 246 text, 473 paragraph, 342 absent-text, 278 heading, 38 heading-level,
64 absent-heading, 82 list-item, 51 list, 31 preformatted-block, 1 preformatted-lines, 29 script,
...
<!-- counts:swift-tests -->1028 Swift tests<!-- counts:end --> with no known-issue wrappers, and <!-- counts:python-tests -->249 Python tests<!-- counts:end -->.
