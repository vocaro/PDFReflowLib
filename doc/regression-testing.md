...
- `swift test`: <!-- counts:swift-tests -->1042 Swift Testing tests<!-- counts:end --> with no known-issue wrappers, using the real Apple
...
<!-- counts:contract-coverage -->1567 checks on 284 reviewed pages across 24 documents<!-- counts:end -->.
...
Those 1567 checks are 4 `spineContinuity`, 127 `text`, 818 `orderedText`, 78 `absentText`,
52 `headings`, 154 `paragraphs`, 19 `continuedParagraphs`, 10 `preformatted`,
6 `absentPreformatted`, 15 `lists`, 14 `asides`, 2 `quotations`, 20 `scripts`, 11 `math`,
11 `imageRegions`, 37 `tableRows`, 126 `minimumImages`, 1 `originalPageImage`,
