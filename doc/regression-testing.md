...
<!-- counts:coverage -->
[corpus/regressions.json](../corpus/regressions.json) has 3843 targeted checks on 616 reviewed pages
...
1235 ordered-text, 246 text, 465 paragraph, 342 absent-text, 278 heading, 38 heading-level,
...
<!-- counts:swift-tests -->1033 Swift tests<!-- counts:end --> with no known-issue wrappers, and <!-- counts:python-tests -->249 Python tests<!-- counts:end -->.
