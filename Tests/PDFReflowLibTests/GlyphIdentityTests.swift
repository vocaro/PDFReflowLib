...
@Test func anIsolatedRedrawnGlyphIsNeverReadAsAnInlineSuperscript() throws {
    ...
    value.append(NSAttributedString(string: "ar ", attributes: [.font: GlyphTestFont(name: "Helvetica", size: 11)!, key: 0]))
    let bulletRange = NSRange(location: value.length, length: 1)
    value.append(NSAttributedString(string: "\u{25CF}", attributes: [.font: GlyphTestFont(name: "Helvetica", size: 6)!, key: 4]))
    value.addAttribute(GlyphIdentityReader.isolatedAttribute, value: true, range: bulletRange)
    value.append(NSAttributedString(string: " Follow", attributes: [.font: GlyphTestFont(name: "Helvetica", size: 11)!, key: 0]))
    value.append(NSAttributedString(string: "2", attributes: [.font: GlyphTestFont(name: "Helvetica", size: 8)!, key: 4]))
