...
- `swift test`: <!-- counts:swift-tests -->1045 Swift Testing tests<!-- counts:end --> with no known-issue wrappers, using the real Apple
...
<!-- counts:contract-coverage -->1580 checks on 286 reviewed pages across 24 documents<!-- counts:end -->.
...
Those 1580 checks are 4 `spineContinuity`, 127 `text`, 818 `orderedText`, 78 `absentText`,
