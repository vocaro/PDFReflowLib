...
# (twenty-one; the Arabic and Chinese cases are not judged).
...
pdfs=(cdc cdc_6023_DS1.pdf bluebook CIA-UAP-015-Project_Blue_Book_Special_Report_No_14.pdf
      ...
      prose1 complaint_for_a_civil_case.pdf nasa 20200002975.pdf agresearch November-December2012.pdf
      dasc 20190030725.pdf earthdata 20180003024.pdf techport THM-Close-Out-Report-and-Exec-Summ-for-STI-Review.pdf)
books=($@)
[ ${#books} -eq 0 ] && books=(cdc bluebook warren nbs census dga faa algebra 911 flag fed loper replay usgs noaa prose1 nasa agresearch dasc earthdata techport)
