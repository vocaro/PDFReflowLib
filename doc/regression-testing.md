...
<!-- counts:coverage -->
[corpus/regressions.json](../corpus/regressions.json) has 4098 targeted checks on 644 reviewed pages
...
1331 ordered-text, 254 text, 509 paragraph, 407 absent-text, 284 heading, 38 heading-level,
...
1 list-item-continuation, 8 paragraph-separation, 140 distinct-paragraph, 217 image-presence,
46 captioned-image, 20 image-alternative, 119 page-reference, 133 warning, 134 absent-warning,
...
<!-- counts:swift-tests -->1070 Swift tests<!-- counts:end --> with no known-issue wrappers, and <!-- counts:python-tests -->261 Python tests<!-- counts:end -->.
