...
- `swift test`: <!-- counts:swift-tests -->1039 Swift Testing tests<!-- counts:end --> with no known-issue wrappers, using the real Apple
...
<!-- counts:contract-coverage -->1555 checks on 280 reviewed pages across 24 documents<!-- counts:end -->.
...
Those 1555 checks are 4 `spineContinuity`, 127 `text`, 812 `orderedText`, 72 `absentText`,
