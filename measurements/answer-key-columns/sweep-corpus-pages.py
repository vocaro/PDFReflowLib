...
time. Prints one line per case: the pages that differ, or `identical`.
"""
import json
import os
import re
...
ROOT = '/Users/trevorharmon/Development/PDFReflowLib/.claude/worktrees/agent-a6c69222c251e9dfd'
SCRATCH = '/private/tmp/claude-501/i178'
BASELINE = SCRATCH + '/pdf-reflow-baseline'
CANDIDATE = ROOT + '/.build/release/pdf-reflow'
