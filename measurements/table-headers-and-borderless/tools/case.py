#!/usr/bin/env python3
"""usage: case.py <case-id> [base] [cand] [compare]  lanes for one corpus case, compare, keep both EPUBs for page review, delete outputs.
...
S = os.environ['TABLE_HEADERS_WORK']
W = str(Path(__file__).resolve().parents[3])
KEEP = W + '/measurements/table-headers-and-borderless/lane-summaries'
case = sys.argv[1]
