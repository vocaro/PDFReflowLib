...
<!-- counts:coverage -->
[corpus/regressions.json](../corpus/regressions.json) has 3547 targeted checks on 582 reviewed pages
...
They comprise 1137 ordered-text, 242 text, 464 paragraph, 314 absent-text, 278 heading,
36 heading-level, 64 absent-heading, 93 list-item, 1 preformatted-lines, 29 script,
10 absent-script, 11 footnote, 34 note-link, 70 paragraph-continuation, 1 list-item-continuation,
8 paragraph-separation, 123 distinct-paragraph, 200 image-presence, 45 captioned-image,
...
<!-- counts:swift-tests -->989 Swift tests<!-- counts:end --> with no known-issue wrappers, and <!-- counts:python-tests -->245 Python tests<!-- counts:end -->.
