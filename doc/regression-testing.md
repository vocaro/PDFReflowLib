...
<!-- counts:coverage -->
[corpus/regressions.json](../corpus/regressions.json) has 3815 targeted checks on 606 reviewed pages
...
8 paragraph-separation, 125 distinct-paragraph, 212 image-presence, 45 captioned-image,
