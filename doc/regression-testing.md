...
<!-- counts:coverage -->
[corpus/regressions.json](../corpus/regressions.json) has 3646 targeted checks on 587 reviewed pages
...
<!-- counts:swift-tests -->1015 Swift tests<!-- counts:end --> with no known-issue wrappers, and <!-- counts:python-tests -->248 Python tests<!-- counts:end -->.
