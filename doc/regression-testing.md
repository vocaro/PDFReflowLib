...
- `swift test`: <!-- counts:swift-tests -->853 Swift Testing tests<!-- counts:end --> with no known-issue wrappers, using the real Apple
...
<!-- counts:contract-coverage -->1362 checks on 255 reviewed pages across 21 documents<!-- counts:end -->.
...
Those 1362 checks are 4 `spineContinuity`, 117 `text`, 684 `orderedText`, 71 `absentText`,
