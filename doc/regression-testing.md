...
- `swift test`: <!-- counts:swift-tests -->789 Swift Testing tests<!-- counts:end --> with no known-issue wrappers, using the real Apple
...
Those 944 checks are 4 `spineContinuity`, 112 `text`, 374 `orderedText`, 67 `absentText`,
